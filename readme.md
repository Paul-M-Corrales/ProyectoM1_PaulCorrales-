...
Elegir si visualizar los códigos en HEX o HSL.
Hacer clic sobre un código para copiarlo.
Bloquear los colores que se quieran conservar utilizando el candado 🔒.
Generar nuevas paletas manteniendo los colores bloqueados.
Guardar las paletas favoritas para utilizarlas más adelante.
📸 Uso de la aplicación (con imágenes)
...
🌙 Modo oscuro.
🎨 Generación de paletas armónicas (Complementarias, Análogas, Tríadas, etc.).
